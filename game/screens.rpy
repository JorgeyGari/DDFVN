...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Finalizar reproducción") action EndReplay(confirm=True)
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Omitir")
                    textbutton _("Texto nuevo") action Preference("skip", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Velocidad del avance automático")
                ...
                vbox:
                    ...
                    if config.has_sound:
                        ...
                        label _("Volumen de los efectos de sonido")
...
style skip_triangle:
    ...
    ## glyph in it.
    font "fonts/whitneySemiBoldItalic.otf"
